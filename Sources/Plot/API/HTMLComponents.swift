...
public enum ElementDefinitions {
    ...
    public enum Article: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.article } }
    /// Definition for the `<aside>` element.
    public enum Aside: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.aside } }
    /// Definition for the `<button>` element.
    public enum Button: ElementDefinition { public static var wrapper: (Node<HTML.ButtonContext>...) -> Node<HTML.BodyContext> { Node.button } }
    /// Definition for the `<details>` element.
    public enum Details: ElementDefinition { public static var wrapper: (Node<HTML.DetailsContext>...) -> Node<HTML.BodyContext> { Node.details } }
    /// Definition for the `<div>` element.
    public enum Div: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node<HTML.BodyContext>.div } }
    /// Definition for the `<fieldset>` element.
    public enum FieldSet: ElementDefinition { public static var wrapper: (Node<HTML.FormContext>...) -> Node<HTML.BodyContext> { Node.fieldset } }
    /// Definition for the `<footer>` element.
    public enum Footer: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.footer } }
    /// Definition for the `<h1>` element.
    public enum H1: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h1 } }
    /// Definition for the `<h2>` element.
    public enum H2: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h2 } }
    /// Definition for the `<h3>` element.
    public enum H3: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h3 } }
    /// Definition for the `<h4>` element.
    public enum H4: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h4 } }
    /// Definition for the `<h5>` element.
    public enum H5: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h5 } }
    /// Definition for the `<h6>` element.
    public enum H6: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.h6 } }
    /// Definition for the `<header>` element.
    public enum Header: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.header } }
    /// Definition for the `<li>` element.
    public enum ListItem: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.ListContext> { Node.li } }
    /// Definition for the `<main>` element.
    public enum Main: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.main } }
    /// Definition for the `<nav>` element.
    public enum Navigation: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.nav } }
    /// Definition for the `<p>` element.
    public enum Paragraph: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.p } }
    /// Definition for the `<span>` element.
    public enum Span: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.BodyContext> { Node.span } }
    /// Definition for the `<summary>` element.
    public enum Summary: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.DetailsContext> { Node.summary } }
    /// Definition for the `<caption>` element.
    public enum TableCaption: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.TableContext> { Node.caption } }
    /// Definition for the `<td>` element.
    public enum TableCell: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.TableRowContext> { Node.td } }
    /// Definition for the `<th>` element.
    public enum TableHeaderCell: ElementDefinition { public static var wrapper: (Node<HTML.BodyContext>...) -> Node<HTML.TableRowContext> { Node.th } }
}
